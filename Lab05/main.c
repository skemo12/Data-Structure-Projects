...
static char *test_sameTree() {
	...
	sd_assert("Cerința 3 - Test1 sameTree picat", sameTree(tree, result) == 1);
	freeTree(&tree);
	freeTree(&result);
	...
	sd_assert("Cerința 3 - Test2 sameTree picat", sameTree(tree, result) == 1);
	freeTree(&tree);
	freeTree(&result);
	...
	sd_assert("Cerința 3 - Test3 sameTree picat", sameTree(tree, result) == 1);
	freeTree(&tree);
	freeTree(&result);
	...
	sd_assert("Cerința 3 - Test4 sameTree picat", sameTree(tree, result) == 0);
	freeTree(&tree);
	freeTree(&result);
